...
public class VideoStreamSessionManager {
	...
	public void put(String videoType,String deviceId, String channelId ,String ssrc, String streamId, String mediaServerId, ClientTransaction transaction){
		SsrcTransaction ssrcTransaction = new SsrcTransaction();
		ssrcTransaction.setDeviceId(deviceId);
		ssrcTransaction.setChannelId(channelId);
		ssrcTransaction.setStreamId(streamId);
		ssrcTransaction.setVideoType(videoType);
	...
	public void put(String videoType,String deviceId, String channelId , Dialog dialog){
		SsrcTransaction ssrcTransaction = getSsrcTransaction(videoType,deviceId, channelId);
	...
	public ClientTransaction getTransaction(String videoType,String deviceId, String channelId){
		SsrcTransaction ssrcTransaction = getSsrcTransaction(videoType,deviceId, channelId);
	...
	public SIPDialog getDialog(String videoType,String deviceId, String channelId){
		SsrcTransaction ssrcTransaction = getSsrcTransaction(videoType,deviceId, channelId);
		if (ssrcTransaction == null) return null;
	...
	public SsrcTransaction getSsrcTransaction(String videoType,String deviceId, String channelId){
	...
	public String getStreamId(String videoType,String deviceId, String channelId){
		SsrcTransaction ssrcTransaction = getSsrcTransaction(videoType,deviceId, channelId);
		if (ssrcTransaction == null) return null;
		return ssrcTransaction.getStreamId();
	}
	public String getMediaServerId(String videoType,String deviceId, String channelId){
		SsrcTransaction ssrcTransaction = getSsrcTransaction(videoType,deviceId, channelId);
		if (ssrcTransaction == null) return null;
		return ssrcTransaction.getMediaServerId();
	}

	public String getSSRC(String videoType,String deviceId, String channelId){
		SsrcTransaction ssrcTransaction = getSsrcTransaction(videoType,deviceId, channelId);
		if (ssrcTransaction == null) return null;
		return ssrcTransaction.getSsrc();
	}
	
	public void remove(String videoType,String deviceId, String channelId) {
		SsrcTransaction ssrcTransaction = getSsrcTransaction(videoType,deviceId, channelId);
